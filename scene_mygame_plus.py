        ...
        for event in pygame.event.get():
            ...
            # -------------------------------if clicked on Next------------------------------------------
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if self.level == 1:
                        self.operand1 = random.randint(10, 100)
                        self.operand2 = random.randint(10, 100)
                    elif self.level == 2:
                        self.operand1 = random.randint(100, 1000)
                        self.operand2 = random.randint(100, 1000)
                    elif self.level == 3:
                        self.operand1 = random.randint(1000, 10000)
                        self.operand2 = random.randint(1000, 10000)
