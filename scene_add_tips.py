...
class add_tips(Scene):
    ...
    def __init__(self, display, userId):
        ...
        self.title_surface = self.title_font.render('TIPS ADDING SYSTEM', True, 'Black')
        ...
        self.send_button_rec = self.text_box_surf.get_rect(midtop=(700, 550))
